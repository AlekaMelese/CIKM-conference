...
def save_metadata(config: GemmaNarrativeConfig, train_result, df: pd.DataFrame):
    ...
    metadata_path = f"{config.OUTPUT_DIR}/qwen_narrative_metadata.json"
...
def main():
    ...
    create_narrative_training_plots(trainer, config, model_name="Qwen2-7B Narrative", df=df)
    ...
    print(f"   - Metadata: {config.OUTPUT_DIR}/qwen_narrative_metadata.json")
