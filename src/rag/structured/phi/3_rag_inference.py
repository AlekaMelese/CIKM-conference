...
WORKFLOW:
1. Fine-tuned Phi-3-Medium-14B model (Phase 1) - Domain-adapted for clinical summaries
...
class HybridPEFTRAGInference:
    ...
    def __init__(self):
        ...
        print("Fine-tuned Phi-3-Medium-14B + Structure-Focused Retrieval")
        print("=" * 80)
    ...
    def _load_finetuned_model(self):
        """Load Phase 1 fine-tuned Phi-3-Medium-14B model (Unsloth or regular transformers)"""
        ...
        if UNSLOTH_AVAILABLE:
            ...
            print(f"   Using Unsloth optimizations with 4-bit quantization...")
...
"""
    ...
    def generate_section(self, input_text: str, section_name: str,
        ...
        UPDATED: Temperature 0.3 → 0.4, improved prompts with examples for cleaner output
        """
...
Case Type:""",
            ...
            "patient_service": f"""[INST] Extract ONLY the patient gender and medical service from this clinical note. Write in format: "Gender, Service"
...
Write only patient and service (one line): [/INST]

•  Patient & Service:""",

            "chief_complaint": f"""[INST] Extract the chief complaint (main symptom/reason for admission) from this clinical note. Write ONLY 1-2 sentences. Do NOT include procedures or detailed history.
...
Write only the chief complaint (1-2 sentences): [/INST]
