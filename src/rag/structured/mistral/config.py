...
1. PEFT (Phase 1): Fine-tuned Mistral model provides clinical domain adaptation
...
class RAGConfig:
    ...
    PHASE1_MODEL_NAME = "unsloth/mistral-7b-instruct-v0.2-bnb-4bit"
...
"""
    ...
    def print_config(cls):
        ...
        print(f"\n🤖 MODELS")
        print(f"  Generator (PEFT): Fine-tuned Mistral-7B (Phase 1)")
