...
1. PEFT (Phase 1): Fine-tuned Qwen2-7B-Instruct model provides clinical domain adaptation
...
class RAGConfig:
    ...
    # Phase 1 fine-tuned Qwen model path
    PHASE1_MODEL_NAME = "unsloth/Qwen2-7B-Instruct-bnb-4bit"
    ...
    # Model generation parameters (OPTIMIZED - same as qwen_constrained_generation.py)
...
"""
    ...
    def print_config(cls):
        ...
        print(f"\n🤖 MODELS")
        print(f"  Generator (PEFT): Fine-tuned Qwen2-7B-Instruct (Phase 1)")
