...
1. PEFT (Phase 1): Fine-tuned Gemma-2-9B-IT model provides clinical domain adaptation
...
class RAGConfig:
    ...
    # Model generation parameters (OPTIMIZED - same as gemma_constrained_generation.py)
...
"""
    ...
    def print_config(cls):
        ...
        print(f"\n🤖 MODELS")
        print(f"  Generator (PEFT): Fine-tuned Gemma-2-9B-IT (Phase 1)")
