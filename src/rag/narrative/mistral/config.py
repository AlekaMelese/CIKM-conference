...
1. PEFT (Phase 1): Fine-tuned Mistral-7B-Instruct model provides clinical domain adaptation
...
class RAGConfig:
    ...
    # Phase 1 fine-tuned Mistral model path
    PHASE1_MODEL_NAME = "unsloth/mistral-7b-instruct-v0.3-bnb-4bit"
    ...
    # Model generation parameters (OPTIMIZED - same as mistral_constrained_generation.py)
...
"""
    ...
    def print_config(cls):
        ...
        print(f"\n🤖 MODELS")
        print(f"  Generator (PEFT): Fine-tuned Mistral-7B-Instruct (Phase 1)")
