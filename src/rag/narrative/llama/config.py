...
1. PEFT (Phase 1): Fine-tuned Llama-3.1-8B-Instruct model provides clinical domain adaptation
...
class RAGConfig:
    ...
    PROJECT_ROOT = BASE_DIR.parent.parent.parent  # ./Llama
    ...
    # Phase 1 fine-tuned Llama model path
    PHASE1_MODEL_NAME = "unsloth/Meta-Llama-3.1-8B-Instruct-bnb-4bit"
    ...
    # Model generation parameters (OPTIMIZED - same as llama_constrained_generation.py)
...
"""
    ...
    def print_config(cls):
        ...
        print(f"\n🤖 MODELS")
        print(f"  Generator (PEFT): Fine-tuned Llama-3.1-8B-Instruct (Phase 1)")
