...
1. PEFT (Phase 1): Fine-tuned BioMistral-7B model provides clinical domain adaptation
...
class RAGConfig:
    ...
    # Phase 1 fine-tuned BioMistral model path
    PHASE1_MODEL_NAME = "BioMistral/BioMistral-7B"
    ...
    # Model generation parameters (OPTIMIZED - same as biomistral_constrained_generation.py)
...
"""
    ...
    def print_config(cls):
        ...
        print(f"\n🤖 MODELS")
        print(f"  Generator (PEFT): Fine-tuned BioMistral-7B (Phase 1)")
